        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            <div className="inline-flex items-center justify-center mb-4">
              <img src={schoolLogo} alt="شعار المدرسة" className="h-32 w-auto" />
            </div>
            <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" dir="rtl">
              ...
              <div className="space-y-2">
                ...
                <Select value={subject} onValueChange={setSubject}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="التربية الأسلامية">التربية الأسلامية</SelectItem>
                    <SelectItem value="الأجتماعيات">الأجتماعيات</SelectItem>
                    ...
                    <SelectItem value="الدراسات العمليه">الدراسات العمليه</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  يمكنك إضافة أي معلومات إضافية أو ملاحظات خاصة بالحصة
                </p>
              </div>
